...
# --- Configuration ---
CKPT_PATH = "/content/swgo_pipeline/swgo_trainv2_run_results_20250916_112803/ckpts/epoch=319.ckpt"
BATCH_SIZE = 512
...
def main():
    ...
    dm = SWGODataModule(
        h5_path="/content/drive/MyDrive/Colab Notebooks/SWGO/test_perfect.h5",      
